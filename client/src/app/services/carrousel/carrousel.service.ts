...
export class CarrouselService {
    ...
    getFilteredDrawings(tags: Tag[]): Observable<Drawing[]> {
        ...
        this.deleteDrawingDataFromId(drawing);
        console.log("allo");
        return this.http.get<Drawing[]>(this.baseURL);
    }
    
    deleteDrawingDataFromId(drawing: Drawing): Observable<{}> {
        const url = `${this.baseURL}/?ids=${drawing.data._id}`;
