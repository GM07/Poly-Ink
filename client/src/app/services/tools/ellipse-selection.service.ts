...
export class EllipseSelectionService extends RectangleSelectionService {
    ...
    protected startSelection(): void {
        ...
        this.updateSize(
            this.mouseUpCoord.x - this.mouseDownCoord.x,
            this.mouseUpCoord.y - this.mouseDownCoord.y,
    ...
    protected updateSelection(translation: Vec2): void {
        ...
        this.updateSize(this.width, this.height, left, top);
        ...
        ctx.ellipse(this.centerX, this.centerY, this.radiusXAbs, this.radiusYAbs, 0, 0, 2 * Math.PI);
        ctx.clip();
        ctx.drawImage(this.imagedata_to_image(this.selectionData), left, top);
    ...
    protected endSelection(): void {
        ...
        baseCtx.clip();
        baseCtx.drawImage(this.imagedata_to_image(this.selectionData), this.selectionCoords.x, this.selectionCoords.y);
        baseCtx.restore();
