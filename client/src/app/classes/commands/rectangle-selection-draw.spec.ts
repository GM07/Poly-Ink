...
describe('RectangleSelectionDraw', () => {
    ...
    beforeEach(() => {
        ...
        rectangleSelectionDraw['config'].SELECTION_DATA.width = 10;
        rectangleSelectionDraw['config'].SELECTION_DATA.height = 10;
        const ctx = rectangleSelectionDraw['config'].SELECTION_DATA.getContext('2d') as CanvasRenderingContext2D;
