...
describe('EraserConfigComponent', () => {
    ...
    it('should change line width on slider change', () => {
        component.eraserService.config.lineWidth = 1;
        component.changeLineWidth({ value: 2 } as MatSliderChange);
        expect(component.eraserService.config.lineWidth).toBe(2);
    });
});
