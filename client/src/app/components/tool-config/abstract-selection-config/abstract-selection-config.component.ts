...
export class AbstractSelectionConfigComponent extends ToolConfig implements OnDestroy, AfterViewInit {
    ...
    constructor(selectionService: AbstractSelectionService, drawingService: DrawingService) {
        super();
