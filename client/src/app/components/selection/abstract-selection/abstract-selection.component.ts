...
export class AbstractSelectionComponent implements OnDestroy, AfterViewInit, OnInit {
    ...
    updateSubscirption: Subscription;
    ...
    ngOnInit(): void {
        this.updateSubscirption = this.selectionService.updatePoints.subscribe((display: boolean) => {
            console.log(display);
    ...
    ngOnDestroy(): void {
        ...
        this.updateSubscirption.unsubscribe();
    }
